package com.sulake.core.communication.messages
{
   ...
   public class MessageClassManager implements IMessageClassManager
   {
      ...
      {
         super();
         var_787 = new Dictionary();
         var_657 = new Dictionary();
      }
      
      private function method_7(param1:int, param2:Class) : Boolean
      {
         var _loc5_:* = null;
      ...
      public function getMessageComposerID(param1:IMessageComposer) : int
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = -1;
         for(_loc3_ in var_787)
         {
            _loc4_ = var_787[_loc3_] as Class;
            if(param1 is _loc4_)
            {
      ...
      public function registerMessages(param1:IMessageConfiguration) : Boolean
      {
         ...
         {
            method_7(parseInt(_loc2_),param1.composers[_loc2_]);
         }
         return true;
      }
      ...
      {
         var _loc2_:Array = var_657[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function toString() : String
      {
         ...
         for(_loc2_ in var_787)
         {
            _loc1_ += _loc2_ + " -> " + var_787[_loc2_] + "\n";
         }
         _loc1_ += "Registered Message Event Classes: \n";
         for(_loc2_ in var_657)
         {
            _loc1_ += _loc2_ + " -> " + var_657[_loc2_] + "\n";
         }
         return _loc1_;
      }
      ...
      private function registerMessageEvent(param1:int, param2:Class) : Boolean
      {
         ...
         if(_loc3_..implementsInterface.@type == _messageEventInterface)
         {
            ...
            if(true)
            {
               var_657[param1] = [param2];
            }
            else
            {
               _loc6_ = var_657[param1];
               _loc6_.push(param2);
            }
            return true;
         }

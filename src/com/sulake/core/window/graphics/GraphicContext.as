package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_802:uint = 256;
      
      protected static var var_652:uint = 0;
      
      protected static var var_385:uint = 0;
      
      public static const const_816:uint = 2;
      
      public static const const_1567:uint = 128;
      
      public static const const_1535:uint = 64;
      
      public static const const_663:uint = 4;
      
      public static const const_1386:uint = 0;
      
      public static const const_1223:uint = 16;
      
      public static const const_524:uint = 1;
      ...
      protected var var_649:Boolean;
      
      protected var var_1621:Boolean;
      
      protected var var_166:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1385:
               ...
               break;
            case GraphicContext.const_1223:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_663:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_802:
               break;
            case GraphicContext.const_1386:
               break;
            default:
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_166 = new Sprite();
            var_166.name = this.name + " - Child Container";
            var_166.mouseEnabled = false;
            addChild(var_166);
         }
         return var_166;
      }
         ...
         if(var_649)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1621,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1621,16777215);
                  }
                  var_385 += bitmap.width * bitmap.height * 4;
               }

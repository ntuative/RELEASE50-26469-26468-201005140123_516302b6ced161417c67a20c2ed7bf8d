package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1498:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_588 = new Array();
         var_1497 = new Point();
         var_1498 = new Rectangle();
         var_315 = new Rectangle();
         var_314 = new Dictionary(true);
         var_667 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_314[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_315.x = _loc3_.dirty.x;
               var_315.y = _loc3_.dirty.y;
               var_315.width = _loc3_.dirty.width;
               var_315.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_315);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_691,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_314[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1497,var_1498))
            {
               if(param2.render(param1,var_1497,var_1498))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_314[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_691,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_315.x = param2.x - param1.x;
            var_315.y = param2.y - param1.y;
            var_315.width = param2.width;
            var_315.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_35))
            {
               while(param1.testParamFlag(WindowParam.const_35))
               {
                  ...
                  var_315.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_315,WindowRedrawFlag.const_240);

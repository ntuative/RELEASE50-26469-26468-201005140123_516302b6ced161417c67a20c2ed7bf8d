package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_135:DropMenuController;
      
      private var var_514:int = -1;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_135 == null || false)
         {
            var_135 = context.create(name + "::submenu","",WindowType.const_439,var_80,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_135.setGlobalRectangle(_loc1_);
         }
         var_135.activate();
         return var_135;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_94)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_85))
               {
         ...
         else if(param1.type == WindowEvent.const_935)
         {
            if(param2 == var_135)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_490,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_331,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_514 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_514).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_616)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_515,getSubMenu(),subMenuEventProc);
                  var_616 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_514 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_307,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_135 != null)
            {
               _loc2_ = var_135.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_616 = false;
            getTitleText().text = var_514 < var_515.length && var_514 > -1 ? "null" : caption;
         }
      }
   }
}

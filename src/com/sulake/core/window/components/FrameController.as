package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_775:String = "margin_top";
      
      private static const const_1102:String = "_HEADER";
      
      private static const const_776:String = "margin_right";
      
      private static const const_1100:String = "_SCALER";
      
      private static const const_1101:String = "_TITLE";
      
      private static const const_1099:String = "_CONTENT";
      
      private static const const_777:String = "margin_left";
      ...
      private var var_1303:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_777,_loc3_.left,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_775,_loc3_.top,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_776,0 - _loc3_.right,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_778,0 - _loc3_.bottom,PropertyStruct.const_67,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_277);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1303 == null)
         {
            var_1303 = findChildByTag(const_1102) as IHeaderWindow;
            if(!var_1303)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1101) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1100) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1399 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1099) as IWindowContainer;
            if(!var_20)
            {

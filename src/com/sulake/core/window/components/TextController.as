package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_548:String = "none";
      ...
      {
         return new Rectangle(var_644 * maxScrollH,var_379 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_776)
         {
            context.removeLocalizationListener(var_330,this);
         }
         if(var_68 != null)
         {
            var_68.dispose();
      ...
      {
         var_644 = param1;
         _field.scrollH = var_644 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_330 = param1;
         if(var_330.charAt(0) == "$" && var_330.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_330.slice(2,var_330.indexOf("}")),this);
            var_776 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_948,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_470,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_63,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_470,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_63,true));
         ...
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_585,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_585,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_left",var_68.left,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_top",var_68.top,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_right",var_68.right,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_68.bottom,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("auto_size",var_548,PropertyStruct.STRING,var_548 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_63,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_63,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_63,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_63,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_585,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_548 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_548 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_548 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_548 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }

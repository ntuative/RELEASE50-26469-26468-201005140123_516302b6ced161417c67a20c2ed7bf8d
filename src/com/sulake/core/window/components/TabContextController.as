package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1070:String = "content";
      
      private static const const_1071:String = "selector";
       
      
      private var var_1157:Boolean = false;
      
      protected var var_956:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1617 == null)
         {
            var_1617 = findChildByTag(TabContextController.const_1070) as IWindowContainer;
         }
         return var_1617;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_956 == null)
         {
            var_956 = findChildByTag(TabContextController.const_1071) as ITabSelectorWindow;
            if(var_956 != null)
            {
               var_956.procedure = selectorEventProc;
            }
         }
         return var_956;
      }
      ...
      {
         return !!var_835 ? selector.iterator : null;
      }

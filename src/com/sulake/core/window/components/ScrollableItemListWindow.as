package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_902:IItemListWindow;
      
      private var var_364:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_364)
         {
            var_364 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_364)
            {
               var_364.addEventListener(WindowEvent.const_264,scrollBarEventProc);
               var_364.addEventListener(WindowEvent.const_231,scrollBarEventProc);
            }
         }
         return var_364;
      }
      ...
      override public function dispose() : void
      {
         if(var_364)
         {
            var_364.removeEventListener(WindowEvent.const_264,scrollBarEventProc);
            var_364.removeEventListener(WindowEvent.const_231,scrollBarEventProc);
            var_364 = null;
         }
         if(var_902)
         {
      ...
      {
         if(param1.type == WindowEvent.const_264)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_902)
         {
            var_902 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_902;
      }

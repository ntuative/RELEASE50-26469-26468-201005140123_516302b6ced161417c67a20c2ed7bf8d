package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1189:uint = 0;
       
      
      protected var var_163:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_382 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_57 = var_382.clone();
            var_8 = var_382.clone();
         ...
         if(_loc13_)
         {
            ...
            if(var_647 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_550 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_93);
                  if(_loc13_)
                  {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_120,WindowParam.const_150);
         var _loc2_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_147);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_269)
               {
                  _loc3_.width += _loc4_;
               }
      ...
      {
         var_647 = param1;
         var_550 = !!var_647 ? uint(var_550 | var_1396) : uint(var_550 & 16777215);
         var_163 = var_163 || param1;
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_76);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1785 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_970:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_299:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_917:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1197:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1248:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_950:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_598:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_904:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_368:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_80 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_368,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_524,var_8);
            var_17.visible = var_375;
         }
         return var_17;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_937);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1003 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_332,this,param1));
         return param1;
      }
      ...
      {
         var_1396 = param1 & 4278190080;
         var_550 = !!var_647 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_76);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_640))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_880;
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_277))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_163:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_408,this,null));
                     if(testParamFlag(WindowParam.const_165,WindowParam.const_150))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_147))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_416))
                        {
                           var_9.width += 0 - 0;
                        }
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_249,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_425:
                  var_16.invalidate(this,var_8.union(var_57),WindowRedrawFlag.const_404);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_961,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_251,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_299:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_694,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_211,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_393:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_998);
                  break;
               case WindowNotifyEvent.const_368:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_459:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_404);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_211:
                  ...
                  break;
               case WindowNotifyEvent.const_408:
                  var_9.getRegionProperties(null,var_303);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_332:
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_299;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_536;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1003 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_34 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_393,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_476)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_461)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_460)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_830,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_628,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_163,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1316,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1293,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_65,false);
         _loc1_.type = WindowNotifyEvent.const_1301;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_303 = var_9.rectangle.clone();
               var_57.x = var_8.x;
               var_57.y = var_8.y;
               var_57.width = var_8.width;
               var_57.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_446,this,var_9));
            }
            else
            {
               var_303.x = 0;
               ...
               var_303.width = 0;
               var_303.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_944,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_645,properties,var_648.concat(),_id) as WindowController;
         _loc2_.var_551 = var_551;
         _loc2_.var_163 = var_163;
         _loc2_.var_1394 = var_1394;
         _loc2_.var_303 = var_303.clone();
         _loc2_.var_8 = var_8.clone();
         _loc2_.var_382 = var_382.clone();
         ...
         _loc2_.var_550 = var_550;
         _loc2_.var_1396 = var_1396;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_598;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_474;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_34 == WindowState.const_440)
         {
            return true;
         }
         var_34 = WindowState.const_440;

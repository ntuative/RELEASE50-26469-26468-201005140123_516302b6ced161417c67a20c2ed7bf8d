package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1605:String = "_INCLUDE";
      
      public static const const_866:String = "_EXCLUDE";
      
      public static const const_1580:String = "_TEMP";
      
      private static const const_1137:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1138:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1125:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_961:Dictionary;
      
      protected var var_1402:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1125 = new Dictionary();
         TypeCodeTable.fillTables(var_1124,var_1125);
         var_961 = new Dictionary();
         var_1401 = new Dictionary();
         ParamCodeTable.fillTables(var_961,var_1401);
         var_1402 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1138,"");
         return param1.replace(const_1137,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1125)
            {
               delete var_1125[_loc1_];
            }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_866) == -1)
                  {

package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1015:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_575:uint = 0;
      
      public static const const_928:String = "AssetLibraryReady";
      
      public static const const_1359:String = "AssetLibraryUnloaded";
      
      public static const const_374:String = "AssetLibraryLoaded";
      
      public static const const_1344:String = "AssetLibraryLoadError";
       
      
      private var var_481:XML;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_404)
         {
            _loc4_ = AssetTypeDeclaration(var_404[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_403)
         {
            _loc2_ = var_403[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_403[_loc1_];
         }
         ...
         var_305 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1359));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_481 = _loc2_.manifest.copy();
         var_348 = _loc2_.resource;
         if(var_480)
         {
            AssetLibrary.fetchLibraryContents(this,var_481,var_348);
         }
         var_305 = true;
         dispatchEvent(new Event(AssetLibrary.const_374));
         dispatchEvent(new Event(AssetLibrary.const_928));
         if(var_480)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_403[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_997,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_896,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_967,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_403[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_404.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_404[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1015.splice(var_1015.indexOf(this),1);
            --var_575;
            var_403 = null;
            var_692 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_349.length ? getAssetByName(var_349[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1344));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_404)
         {
            _loc3_ = AssetTypeDeclaration(var_404[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1394);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_481.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_348[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_403[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_349.splice(var_349.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_404[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_348 != null ? false : false;
      }
   }
}

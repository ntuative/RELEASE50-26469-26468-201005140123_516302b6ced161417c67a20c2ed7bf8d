package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_954:LoaderContext;
      
      protected var var_32:Array;
      
      protected var var_549:Array;
      
      private var var_652:uint = 0;
      
      protected var var_381:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_32 = new Array();
         var_549 = new Array();
         var_954 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_381 = new AssetLibrary("lib-" + var_652++);
         var_32.push(var_381);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_381.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_381.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_549.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_381.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_381.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_381.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_381.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_652++);
         var_549.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_549.length)
            {
               _loc3_ = var_549[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_549.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_381.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_381.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_381.loadFromArchive(param1,param2);
      }

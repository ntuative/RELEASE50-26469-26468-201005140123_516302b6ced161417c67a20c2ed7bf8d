package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_641:Number = 64;
      
      public static const const_840:Number = 32;
      ...
      {
         if(var_417 != param1 * var_1499)
         {
            var_417 = param1 * var_1499;
            ++var_77;
         }
      }
      ...
      {
         if(var_415 != param1 * var_1501)
         {
            var_415 = param1 * var_1501;
            ++var_77;
         }
      }
      ...
      {
         if(var_416 != param1 * var_1500)
         {
            var_416 = param1 * var_1500;
            ++var_77;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1027.assign(_loc22_);
         }
         else
         {
            var_1027.assign(_loc17_);
         }
         ++var_77;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_416;
         _loc2_.z *= var_417;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1027);
         if(_loc3_ < var_2370 || _loc3_ > var_2371)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_416;
            _loc2_.z *= var_417;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1027);
         }
      ...
      {
         return new Vector3d(0 * var_415,0 * var_416,0 * var_417);
      }
      ...
      {
         return scale == const_641;
      }
      
      public function get scale() : Number
      {
         return var_206 / Math.sqrt(0.5);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_206;
         var _loc6_:Number = -param1.y / var_206;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_87,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_415,0 * var_416,0 * var_417);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_415,param2.y * var_416,param2.z * var_417);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_415,param3.y * var_416,param3.z * var_417);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_415,param4.y * var_416,param4.z * var_417);

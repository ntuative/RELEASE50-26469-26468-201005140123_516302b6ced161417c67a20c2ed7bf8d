package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_789:int = 50;
      ...
      private var var_2188:Number = -10000000;
      
      private var var_2187:Number = -10000000;
      
      private var var_2376:int = 0;
      
      private var var_534:RoomObjectCache;
      
      private var var_755:int;
      
      private var var_282:Sprite;
      
      private var var_1092:IRoomRenderingCanvasMouseListener = null;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_56.graphics.beginFill(var_2376);
      ...
      {
         var _loc11_:Number = param1 - var_755 / 2;
         var _loc12_:Number = param2 - var_756 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_755 != var_2191 || var_756 != var_2190)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_448.sortOn("z",0 | 0);
         if(_loc6_ < var_448.length)
         {
            var_448.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_448[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_920.push(_loc12_ - _loc2_);
         if(var_920.length == const_789)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_789)
            {
               _loc13_ += var_920[_loc14_];
               _loc14_++;
            }
            var_920 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_532.length)
            {
               cleanSprite(var_532[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_532 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_325 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_325.getKey(_loc1_);
            _loc3_ = var_325.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1092 != null)
                  {
                     var_1092.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1587,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_448.length)
         {
            return null;
         }
         return var_448[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_533.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_533.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2188 || param2 != var_2187)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_533.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_533.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_532.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc4_:ExtendedSprite = var_56.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_534.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_534.getObjectCache(param2);
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_755 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_756))
                  {

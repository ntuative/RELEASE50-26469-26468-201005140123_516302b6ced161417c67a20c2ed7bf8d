package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1096:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_529,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_115,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_58,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_529,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_115,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_58,onDoorbellHandled);
      }

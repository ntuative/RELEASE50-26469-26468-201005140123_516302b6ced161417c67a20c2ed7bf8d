package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_922:MeMenuSettingsView;
      
      private var var_2390:int;
      
      private var var_599:BitmapData;
      
      private var var_1039:Number = 1;
      
      private var var_1522:int;
      
      private var var_711:Number = 0;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_922.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_599 != null)
            {
               _loc2_.bitmap = new BitmapData(var_599.width,var_599.height,true,16777215);
               _loc2_.bitmap.copyPixels(var_599,var_599.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = buttonProcedure;
               var_1522 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_599 = BitmapData(_loc2_.content);
      }
      
      public function set max(param1:Number) : void
      {
         var_1039 = param1;
         setValue(var_922.volume);
      }
      ...
      {
         return int(var_1522 * (Number(param1 - var_711) / (var_1039 - var_711)));
      }
      ...
      {
         return param1 / var_1522 * (var_1039 - var_711) + var_711;
      }
   }
}

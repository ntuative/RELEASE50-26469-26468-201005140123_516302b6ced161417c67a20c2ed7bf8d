      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_807);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_825));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_510);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_868));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_337);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1007));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_686);
               break;
            case "news":
               if(false && false)
               {

package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_927 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_929 = _window.findChildByName("loader_bar");
         if(var_929 != null)
         {
            var_424 = var_929.width;
            var_172.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_927 != null)
         {
            var_927.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_927.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }

package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_736:MeMenuSettingsViewSlider;
      
      private var var_1564:BitmapData;
      
      private var var_1565:BitmapData;
      
      private var var_737:Number = 1;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_746);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_726);
         }
      ...
      {
         var_737 = param1.volume;
         if(var_736 != null)
         {
            var_736.setValue(var_737);
         }
         method_5();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_736 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         method_5();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_670));
      }
      ...
      private function method_5(param1:BitmapData = null) : void
      {
         if(param1 != null)
         {

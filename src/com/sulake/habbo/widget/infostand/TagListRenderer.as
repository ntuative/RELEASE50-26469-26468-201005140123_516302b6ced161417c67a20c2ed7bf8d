package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1637:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1135 != null && var_1135.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_785 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_785 += param1.height + const_1637;
            return fit(param1);
         }
         param1.offset(_offsetX,var_785);
         _offsetX += param1.width + const_1638;
         return true;
      }

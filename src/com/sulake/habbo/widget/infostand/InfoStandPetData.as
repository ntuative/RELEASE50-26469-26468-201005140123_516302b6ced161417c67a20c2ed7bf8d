package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_2022 = param1.petRace;
         _image = param1.image;
         var_1916 = param1.isOwnPet;
         var_1910 = param1.ownerId;
         _ownerName = param1.ownerName;
         _canOwnerBeKicked = param1.canOwnerBeKicked;
         var_1912 = param1.level;
         var_1917 = param1.levelMax;
         var_1911 = param1.experience;
         var_1909 = param1.experienceMax;
         _energy = param1.energy;
         var_1907 = param1.energyMax;
         _nutrition = param1.nutrition;
         var_1913 = param1.nutritionMax;
         _petRespect = param1.petRespect;
         var_1914 = param1.roomIndex;
         var_1915 = param1.age;
      }

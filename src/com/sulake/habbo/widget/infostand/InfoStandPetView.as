package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1668:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1662:String = "level";
      ...
      private const const_1661:uint = 3355443;
      
      private var var_235:IBorderWindow;
      
      private const const_1664:int = 158;
      
      private const const_1663:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_182:PetCommandTool;
      
      private const const_1667:uint = 11184810;
      ...
      {
         if(var_108 == null || var_235 == null || var_63 == null)
         {
            return;
         }
         ...
         var_235.height = NaN;
         _window.width = Math.max(var_235.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         if(var_182 == null)
         {
            var_182 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1221.getValue(var_608) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_182.showWindow(true);
            var_182.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1662,param1.level,param1.levelMax);
         ...
         updateWindow();
         var_608 = param1.id;
         var_1221.remove(param1.id);
         var_1221.add(param1.id,param1);
         if(var_182 && var_182.isVisible() && param1.isOwnPet)
         {
            var_182.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_182.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_182 && var_182.getPetId() == var_608)
               {
                  var_182.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_431,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1664,const_1663,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1667);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1661);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1668);
         return _loc5_;
      }

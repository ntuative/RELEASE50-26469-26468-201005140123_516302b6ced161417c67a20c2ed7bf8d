package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_502:ChooserView;
      ...
      {
         if(var_502 == null || !var_502.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_502 == null)
         {
            var_502 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_502.populate(param1.items,param1.isAnyRoomController);
      }

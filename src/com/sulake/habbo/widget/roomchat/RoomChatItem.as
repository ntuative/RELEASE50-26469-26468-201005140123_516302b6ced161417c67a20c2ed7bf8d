package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_506:int = 6;
      
      private static const const_355:int = 10;
      
      private static const const_1114:Number = 18;
      
      private static const const_1439:Number = 10;
      ...
      {
         _widget.onItemMouseOut(var_1085,var_1086,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1085,var_748,var_1086,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1339 = param1.chatType;
         var_1085 = param1.userId;
         var_748 = param1.userName;
         var_1086 = param1.userCategory;
         _message = param1.text;
         var_1340 = param1.userX;
         var_209 = param1.userImage;
         var_1084 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_94,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1339)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_250:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_254:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_209 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_209.height);
         }
         ...
         if(var_209 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_209.width;
               _loc28_.height = var_209.height;
               _loc28_.bitmap = new BitmapData(var_209.width,var_209.height,true,0);
               _loc28_.bitmap.copyPixels(var_209,var_209.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_445 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_209.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1084 != 0)
            {
               _loc30_ = uint(var_1084 >> 16 & 255);
               _loc31_ = uint(var_1084 >> 8 & 255);
               _loc32_ = uint(var_1084 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_355;
            }
            else
            {
               _loc19_.text = var_748 + ":";
               _loc19_.y += var_445;
               _loc19_.width = _loc19_.textWidth + const_355;
               _width += _loc19_.textWidth + const_355;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1339 == RoomWidgetChatUpdateEvent.const_250)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_748);
            }
            else if(var_1339 == RoomWidgetChatUpdateEvent.const_254)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_748);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_445;
            _loc20_.width = _loc20_.textWidth + const_506;
            _width += _loc20_.textWidth + const_506;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_355 + _loc20_.textWidth + const_506;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1085,var_1086,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1085,var_1086,_roomId,_roomCategory,param1);
      }

package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1064:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_1025,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_311 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_226 > 0 && param2)
         {
            if(var_1228)
            {
               if(Math.abs(param1 - var_226) <= const_1021)
               {
                  return;
               }
               var_1228 = false;
            ...
            if(var_311)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_43.scrollV < 1 - const_1064 / var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1484)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_311 && !var_1298)
         {
            ...
            var_153.state = RoomChatHistoryPulldown.const_341;
            if(_widget != null)
            {

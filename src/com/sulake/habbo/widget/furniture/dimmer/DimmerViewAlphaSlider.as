package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_94 && param1.type != WindowMouseEvent.const_474)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1522 * (var_1039 - var_711)) + var_711;
      }
   }
}

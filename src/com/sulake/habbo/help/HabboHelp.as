package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_2273:UserRegistry;
      ...
      private var var_772:IHabboConfigurationManager;
      
      private var var_199:IHabboToolbar;
      
      private var var_638:HotelMergeUI;
      
      private var var_300:IHabboCommunicationManager;
      
      private var var_943:FaqIndex;
      ...
      {
         var_1377 = new CallForHelpData();
         var_2273 = new UserRegistry();
         super(param1,param2,param3);
         _assetLibrary = param3;
         var_943 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(var_772)
         {
            var_772.release(new IIDHabboConfigurationManager());
            var_772 = null;
         }
         if(_windowManager)
         {
      ...
      public function initHotelMergeUI() : void
      {
         if(!var_638)
         {
            var_638 = new HotelMergeUI(this);
         }
         var_638.startNameChange();
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_62 = new HelpUI(this,_assetLibrary,_windowManager,var_771,var_199);
         }
         return var_62 != null;
      }
      ...
      {
         var_1377.reportedUserId = param1;
         var_1377.reportedUserName = param2;
         var_62.showUI(HabboHelpViewEnum.const_328);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_976 = new IncomingMessages(this,var_300);
      ...
      {
         var_772 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_772.getKey(param1,param2,param3);
      }
   }
}

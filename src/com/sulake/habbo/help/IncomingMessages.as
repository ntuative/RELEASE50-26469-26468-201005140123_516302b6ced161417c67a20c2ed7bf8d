package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_23.tellUI(HabboHelpViewEnum.const_219,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_268,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_139);
      }
      ...
      {
         var_23.showUI(HabboHelpViewEnum.const_328);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_23.updateTutorial(_loc2_.method_6,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_411);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_547);
         var_23.tellUI(HabboHelpViewEnum.const_547,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_321)
            {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_565);
      }

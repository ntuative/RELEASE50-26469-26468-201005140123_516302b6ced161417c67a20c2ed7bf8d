package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1434:int = 0;
      ...
      private var var_2097:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26469-26468-201005140041");
         var_199 = param5;
         var_107 = new Map();
         var_107.add(HabboHelpViewEnum.const_1306,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_139,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_411,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_268,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_219,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_547,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_328,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_526,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_215,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_107.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_107.add(HabboHelpViewEnum.const_854,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_565,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_275 == HabboHelpViewEnum.const_139 || false)
         {
            return;
         }
         if(var_435 == null)
      ...
      {
         return var_107.getValue(var_275);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_107.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_107.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_2098 = param1;
         var _loc2_:IHelpViewController = var_107.getValue(HabboHelpViewEnum.const_139) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_215:
               showUI(HabboHelpViewEnum.const_215);
               break;
            case CallForHelpResultEnum.const_971:
               showUI(HabboHelpViewEnum.const_854);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_275 == HabboHelpViewEnum.const_139)
         {
            return;
         }
         if(true)
         {
            ...
            var_611.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_611[1],var_611[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_611[0],var_611[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1556;
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_107.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_275);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_199 != null)
            {
               var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_433));
      }

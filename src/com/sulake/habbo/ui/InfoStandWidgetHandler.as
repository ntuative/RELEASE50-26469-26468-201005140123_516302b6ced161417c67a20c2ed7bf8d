package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_126,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_126,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_960);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1018);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_321)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_882)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_698);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_197)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_597);
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_817;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1289);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_597);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_583);
         _loc1_.push(RoomWidgetFurniActionMessage.const_676);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_563);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_527);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1334);
         _loc1_.push(RoomWidgetPetCommandMessage.const_606);
         _loc1_.push(RoomWidgetPetCommandMessage.const_541);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_554:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_583:
            ...
            case RoomWidgetFurniActionMessage.const_266:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_676:
            ...
            case RoomWidgetRoomTagSearchMessage.const_563:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_527:
            ...
            case RoomWidgetUserActionMessage.const_581:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_541:

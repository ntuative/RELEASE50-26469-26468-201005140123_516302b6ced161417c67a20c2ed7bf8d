   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_977,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_733,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_477,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_107,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_733,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_173,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_818,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_952,onHabboClubSubscriptionChanged);
         }
         var_199 = _container.toolbar;
         if(var_199)
         {
            var_199.events.addEventListener(HabboToolbarEvent.const_92,onHabboToolbarEvent);
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_477,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_107,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_107:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_107));
               break;
            case HabboHelpTutorialEvent.const_477:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_383));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_648);
         _loc1_.push(RoomWidgetDanceMessage.const_614);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_531);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_743);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_550);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_553);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_659);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_580);
         _loc1_.push(RoomWidgetStopEffectMessage.const_684);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1379);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1014);
         _loc1_.push(RoomWidgetToolbarMessage.const_722);
         _loc1_.push(RoomWidgetToolbarMessage.const_690);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_543);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1166);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_910);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_657);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_709);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_670);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1333);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_746);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_726);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_644));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_709:
               ...
               break;
            case RoomWidgetWaveMessage.const_648:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_614:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_531:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_743:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_550:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_580:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1007)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_238,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_659:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_886:
                        _catalog.openCatalogPage(CatalogPageName.const_1313,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_868:
                        var_11.toggleInventoryPage(InventoryCategory.const_276);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1203:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_553:
            case RoomWidgetStopEffectMessage.const_684:
            ...
            case RoomWidgetSetToolbarIconMessage.const_820:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1174:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1014:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_657:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_722:
               ...
               if(var_199)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_690:
               ...
               if(var_199 && false)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_462,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_543:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_421));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_670:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_330,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_746:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_330,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_726:
            ...
            case RoomWidgetAvatarEditorMessage.const_617:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_435));
               }
               break;
            default:

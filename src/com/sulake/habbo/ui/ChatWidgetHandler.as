package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_463:Point = null;
      
      private var var_656:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_465 != null)
         {
            ...
            {
               _loc2_ = var_465.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_465.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_656.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_465.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_656.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_708,RoomWidgetChatSelectAvatarMessage.const_525];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_708:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_143,_container.roomSession,0,"Version 26469-26468-201005140041");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_525:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_786 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_786);
            }
            if(var_463 == null)
            {
               var_464.x = 0;
               var_464.y = 0;
               var_464.z = 0;
               var_463 = _loc4_.getScreenPoint(var_464);
               var_786 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_464.x = 0;
            var_464.y = 0;
            var_464.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_464);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_463.x || _loc8_.y != var_463.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_463,_loc5_));

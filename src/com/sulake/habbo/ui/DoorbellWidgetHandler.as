package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_106:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_529,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_115:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_115,_loc2_.userName));
               break;
      ...
      {
         return [RoomSessionDoorbellEvent.const_106,RoomSessionDoorbellEvent.const_115,RoomSessionDoorbellEvent.const_58];
      }

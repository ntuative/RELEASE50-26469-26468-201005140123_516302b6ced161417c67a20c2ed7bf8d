package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_821:IHabboHelp = null;
      ...
      private var var_820:IRoomWidgetFactory = null;
      ...
      private var var_592:IAvatarRenderManager = null;
      ...
      private var var_2274:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_345,onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         {
            var_773 = _roomEngine.loadRoomResources(var_39.roomResources);
            if(false)
            {
               var_1379 = false;
               processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_98));
            }
         }
         if(var_259 != null && true)
         {
            var_1378 = !var_259.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_39.roomId,var_39.roomCategory,var_289[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_345,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2274);
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_820.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_603:
               ...
               if(var_685 != null && _loc3_ == RoomObjectCategoryEnum.const_39)
               {
                  _loc7_ = var_39.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_321)
                  {
                     var_685.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_375:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_742);
            _loc13_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_571);
            _loc14_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_715);
            _loc15_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_569);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_39 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_186,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_314);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_417:
               ...
               var_184 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_294,WindowStyle.const_286,WindowParam.const_93) as IToolTipWindow;
               var_184.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_773 == null || false)
         {
            return;
         }
         var _loc2_:int = var_773.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_773.splice(_loc2_,1);
         }
         if(false)
         {
            var_1379 = true;
      ...
      {
         if(var_18 != null && var_39 != null && var_1378 && var_1379)
         {

package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_479:IHabboSoundManager;
      
      private var var_1182:IHabboAvatarEditor = null;
      
      private var var_259:IAdManager;
      
      private var var_820:IRoomWidgetFactory;
      ...
      private var var_592:IAvatarRenderManager;
      ...
      private var var_821:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_997 = RoomDesktop.const_362;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.habboHelp = var_821;
         _loc3_.moderation = var_685;
         _loc3_.config = _config;
         _loc3_.soundManager = var_479;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_479 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_104:
               if(param1.session != null)
               {
                  ...
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.ZOOM));
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.MEMENU));
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_259.events.addEventListener(AdEvent.const_388,adEventHandler);
            var_259.events.addEventListener(AdEvent.const_364,adEventHandler);
            var_259.events.addEventListener(AdEvent.const_484,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_820 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_820 != null)
         {
            var_820.release(new IIDHabboRoomWidget());
            var_820 = null;
         }
         if(var_11 != null)
         {
         ...
         if(var_479 != null)
         {
            var_479.release(new IIDHabboSoundManager());
            var_479 = null;
         }
         if(var_259 != null)
         {
         ...
         if(var_592 != null)
         {
            var_592.release(new IIDAvatarRenderManager());
            var_592 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_821 != null)
         {
            var_821.release(new IIDHabboHelp());
            var_821 = null;
         }
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_256);
            if(_loc3_ != RoomDesktop.const_362)
            {
               var_997 = _loc3_;
            }
            _loc2_.dispose();
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_620:
               ...
               if(_roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_186,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_256);
               if(var_997 != RoomDesktop.const_362)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_256,var_997);
               }
               if(var_259 != null)
               {
                  var_259.showRoomAd();
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_239:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_522:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_688:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_589:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_548,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_620,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_603,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_375,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_100,roomObjectEventHandler);
         }
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_592 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_323,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionChatEvent.const_143,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_110,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_106,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_115,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_58,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPresentEvent.const_279,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_980,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_906,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_522,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_589,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_595,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_361,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_452,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_112,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_548)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;

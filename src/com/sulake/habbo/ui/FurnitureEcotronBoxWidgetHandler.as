package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_83,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_570,RoomWidgetEcotronBoxOpenMessage.const_638,RoomWidgetEcotronBoxOpenedMessage.const_1329];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_279:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_83,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_570:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_638:

package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1418:OpenedToWebPopup;
      
      private var var_801:IAvatarRenderManager;
      
      private var var_199:IHabboToolbar;
      
      private var var_433:FriendListTabs;
      ...
      private var var_1419:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_563:ISessionDataManager;
      ...
      private var var_1706:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_802:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1706 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_89 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1419 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_338.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_338.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_433.findTab(FriendListTab.const_90).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_563 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_338 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_89.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_89.addCategory(new FriendCategory(FriendCategory.const_920,getText("friendlist.friends")));
         var_89.addCategory(new FriendCategory(FriendCategory.const_441,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_89.addFriend(new Friend(_loc4_));
         }
         var_433 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_469)
         {
         ...
         getBuddyRequests();
         registerListeners();
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_801)
         {
            var_801.release(new IIDAvatarRenderManager());
            var_801 = null;
         }
         if(var_802)
         {
            var_802.release(new IIDHabboNotifications());
            var_802 = null;
         }
         if(var_199)
         {
         ...
         if(var_563)
         {
            var_563.release(new IIDSessionDataManager());
            var_563 = null;
         }
         super.dispose();
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_433.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1419.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_186,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_338.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_563.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_563.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_338.limit)
         {
            var_338.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_433.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_801.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_338.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_433.findTab(FriendListTab.const_90);
      ...
      {
         var_802 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1418 == null)
         {
            var_1418 = new OpenedToWebPopup(this);
         }
         var_1418.show(x,y);
      }

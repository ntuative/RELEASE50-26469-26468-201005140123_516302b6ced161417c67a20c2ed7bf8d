package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1429:String = "noconvinfo";
      ...
      private var var_1232:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1232 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_923 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_277 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1232.prepare(var_923);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_1005,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1378,true);
         var_14.header.setParamFlag(HabboWindowParam.const_710,false);
         var_14.header.setParamFlag(HabboWindowParam.const_955,true);
         var_14.content.setParamFlag(HabboWindowParam.const_710,false);
         var_14.content.setParamFlag(HabboWindowParam.const_955,true);
         var_14.findChildByName("open_edit_ctgs_but").procedure = method_10;
         var_1233 = ITextWindow(var_14.findChildByName("info_text"));
         var_1233.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_872,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_710,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_1005,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1492 = var_14.height;
         var_1493 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1492 == -1 ? 0 : int(0 - var_1492);
         var _loc4_:int = var_1493 == -1 ? 0 : int(0 - var_1493);

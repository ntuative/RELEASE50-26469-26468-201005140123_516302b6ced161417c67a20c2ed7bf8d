package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1445:String = "no_reqs_info";
      ...
      private var var_1593:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_287 && _loc4_.state != FriendRequest.const_296)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_287;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_58,_loc4_.requestId));
               }
            }
         }
      ...
      {
         var_1594 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1593 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1593.procedure = onDismissAllButtonClick;
         var_1594.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_287)
         {
         ...
         else if(param1.state == FriendRequest.const_832)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1594,_loc1_);
         setEnabled(var_1593,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_287;
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_58,param1));
         }
      }

package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_825:BitmapData = null;
      ...
      private var var_824:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_484,0,0,_loc4_,var_1444,var_824,var_825));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1763 = int(_config.getKey("interstitial.interval","30000"));
         var_1765 = int(_config.getKey("interstitial.show.time","5000"));
         var_1446 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1186 = _loc2_.imageUrl;
         var_1444 = _loc2_.clickUrl;
         if(var_1186 != "" && var_1444 != "")
         {
            _loc3_ = var_1186;
            ...
            _loc4_ = new URLRequest(var_1186);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1185 = _loc2_.imageUrl;
         var_1764 = _loc2_.clickUrl;
         var_686 = getTimer();
         if(var_1185 != "")
         {
            _loc3_ = var_1185;
            ...
            var_222.start();
            _loc4_ = new URLRequest(var_1185);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_364,0,0,param1.bitmapData,var_1764));
            var_686 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_825 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1446 > 0 && var_1445 >= var_1446)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_686;
         if(_loc1_ > var_1763)
         {
            ++var_1445;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_388));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_824 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }

package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1079:String = "badges";
      
      private static const const_1081:String = "pet_inventory";
      
      private static const const_1078:String = "pixelbalance";
      
      private static const const_1083:String = "credits";
      
      private static const const_1084:String = "inventory";
      
      private static const const_1085:String = "friendlist";
      
      private static const const_1082:String = "selectfurni";
      
      private static const const_1080:String = "selectbadge";
      ...
      private var var_605:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_434:HabboNotificationViewManager;
      
      private var var_726:ClubEndingNotification;
      ...
      private var var_727:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_894);
         }
         var _loc6_:Map = var_894["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1281);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_727 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_202.method_12(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_841)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1214);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_605)
         {
            var_605.release(new IIDHabboToolbar());
            var_605 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_82:
               ...
               break;
            case CatalogPageMessageProductData.const_235:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1270);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2073)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_849);
            var_2073 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1081:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_144);
               }
               break;
            case const_1082:
               break;
      ...
      {
         if(param1 != null && this.var_434 != null)
         {
            var_434.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_849,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_592.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_911,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_704)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_434.isSpaceAvailable() && false)
         {
            var_434.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_1060.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_592.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1391,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_592.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1303)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_726 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_605 = IHabboToolbar(param2);
         var_605.events.addEventListener(HabboToolbarEvent.const_92,onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_92)
         {
            ...
            var_434 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_894["styles"],var_894["view"],var_605);
            ...
            registerUpdateReceiver(var_434,1);
            registerUpdateReceiver(this,2);
            var_360.events.addEventListener(BadgeImageReadyEvent.const_126,onBadgeImage);
            var_605.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}

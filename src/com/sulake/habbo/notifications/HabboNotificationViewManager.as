package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_507:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_507;
         var _loc2_:int = 0;
         while(_loc2_ < var_245.length)
         {
            _loc3_ = var_245[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_622 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_622 + const_507;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2269,var_453,var_199);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_622 < 540;
      }
   }
}

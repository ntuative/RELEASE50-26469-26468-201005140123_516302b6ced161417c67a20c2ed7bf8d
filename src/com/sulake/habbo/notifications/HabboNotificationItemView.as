package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(_window.height < var_1600)
         {
            _window.height = var_1600;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_34)
         {
            ...
            case const_401:
               var_937 += param1;
               _loc2_ = Number(var_937) / Number(var_453["time_fade_in"]);
               if(var_937 > int(var_453["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_798:
               var_1106 += param1;
               if(var_1106 > int(var_453["time_display"]) && !var_1370)
               {
                  startFadeOut();
               }
               break;
            case const_797:
               var_938 += param1;
               _loc3_ = 1 - Number(var_938) / Number(var_453["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_938 > int(var_453["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_199.orientation == "TOP" ? int(const_357) : 0;
         var _loc4_:int = var_199.orientation == "BOTTOM" ? int(_loc2_.height - const_357) : int(_loc2_.height);
         var _loc5_:int = var_199.orientation == "LEFT" ? int(const_357) : 0;
         var _loc6_:int = var_199.orientation == "RIGHT" ? int(_loc2_.width - const_357) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {

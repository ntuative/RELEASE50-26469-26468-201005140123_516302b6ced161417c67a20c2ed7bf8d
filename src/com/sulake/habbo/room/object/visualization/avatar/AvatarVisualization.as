package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_537:BitmapDataAsset;
      
      private const const_1136:int = 3;
      
      private const const_1640:int = 2;
      
      private var var_763:AvatarVisualizationData = null;
      ...
      {
         var_763 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_643);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_566);
         ...
         var _loc13_:int = param2 - var_1367;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_305);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_292 != _loc3_.getUpdateID() || var_213 != param1.scale || var_162 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_437 || var_536 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_536;
            ...
            if(var_321 != _loc7_)
            {
               for each(_loc40_ in var_376.getKeys())
               {
                  _loc41_ = var_376.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_376.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               ...
               _loc6_ = var_763.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_313);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_278) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_278);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_619);
            _loc6_.appendAction(AvatarAction.const_635,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_467);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_381);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_312,AvatarAction.const_1251[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_850);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_956,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_949);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_811);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1016,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_698);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_590);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_876,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_933);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_879,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_377);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_447) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_488);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_855);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_615,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               if(var_538 != null)
               {
                  _loc35_.asset = var_538.content as BitmapData;
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_975))
            {
               ...
               {
                  case 32:
                     var_537 = var_763.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_537 = var_763.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_537 != null)
               {
                  _loc35_.asset = var_537.content as BitmapData;
            ...
            var_792.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_792)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }

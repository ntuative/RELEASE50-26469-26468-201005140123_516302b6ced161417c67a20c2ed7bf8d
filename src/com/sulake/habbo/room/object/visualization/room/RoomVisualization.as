package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1260:int = 13421772;
      
      private static const const_760:int = 16777215;
      
      public static const const_1327:int = 10066329;
      ...
      public static const const_1322:int = 16777215;
      
      private static const const_762:int = 10066329;
      
      private static const const_763:int = 10066329;
      
      public static const const_1173:int = 13421772;
       
      
      private var var_1468:int = 0;
      
      private var var_1234:String = null;
      ...
      private var var_1235:String = null;
      ...
      private var var_577:Rectangle = null;
      
      private var var_1833:int = 255;
      
      private var var_1832:Boolean = false;
      
      private var var_1838:int = 255;
      
      private var var_1834:String = null;
      
      private const const_1655:int = 250;
      ...
      private var var_406:RoomPlaneBitmapMaskParser = null;
      
      private var var_1071:Number = 0;
      ...
      public function RoomVisualization()
      {
         ...
         var_406 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_76.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_271)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_991);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_901);
         var _loc7_:int = 0;
         while(_loc7_ < var_76.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_271)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1322;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1173;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1145)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_224,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_577 == null)
         {
            var_577 = super.boundingRectangle;
         }
         return new Rectangle(var_577.x,var_577.y,var_577.width,var_577.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_406.maskCount)
         {
            _loc6_ = var_406.getMaskType(_loc5_);
            _loc7_ = var_406.getMaskLocation(_loc5_);
            _loc8_ = var_406.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_104.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_224 || _loc3_.type == RoomPlane.const_194 && _loc8_ == RoomPlaneBitmapMaskData.const_216)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1468;
                        if(var_76.getPlaneType(_loc9_) == RoomPlaneData.const_142)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1319)
         {
            var_1319 = param1.updateId;
            var_577 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1071 || _loc9_.y != var_1840 || _loc9_.z != var_1835 || param1.scale != var_1839))
            {
               var_1071 = _loc9_.x;
               var_1840 = _loc9_.y;
               var_1835 = _loc9_.z;
               var_1839 = param1.scale;
               _loc4_ = true;
            }
         }
         var _loc6_:IRoomObjectModel = _loc3_.getModel();
         initializeRoomPlanes();
         if(var_162 != _loc6_.getUpdateID())
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_945);
            if(_loc10_ != var_1834)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_610));
            if(_loc11_ != var_1016)
            {
               var_1016 = _loc11_;
               var_1838 = var_1016 & 255;
               var_1833 = var_1016 >> 8 & 255;
               var_1836 = var_1016 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1700 + const_1655 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1700 = _loc7_;
         if(var_162 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_508);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_720);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_683);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1837 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_891));
            var_162 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_407.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_407[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_194)
            {
               if(var_1837)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1838 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1833 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1836 / 255);

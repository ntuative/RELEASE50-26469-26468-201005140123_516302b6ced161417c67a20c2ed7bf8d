package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_861);
      ...
      {
         if(param1 < var_624.length)
         {
            return var_624[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_239 != null)
         {
            ...
            {
               _loc2_ = var_239[_loc3_];
               _loc2_.update(var_624,var_2170,param1);
               _loc3_++;
            }

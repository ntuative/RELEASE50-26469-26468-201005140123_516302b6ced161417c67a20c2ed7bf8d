package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_757:int = 15;
      
      private static const const_1052:int = 2;
      
      private static const const_348:int = 2;
      
      private static const const_756:int = 31;
      
      private static const const_1051:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1000[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_999[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1000 = new Array();
         var_1000.push(Math.random() * _loc2_ * 1.5);
         var_1000.push(Math.random() * _loc2_ * 1.5);
         var_998 = new Array();
         var_998.push(1);
         var_998.push(-1);
         var_1001 = new Array();
         var_1001.push(const_1052);
         var_1001.push(const_1051);
         var_999 = new Array();
         var_999.push(getRandomAmplitudeFactor());
         var_999.push(getRandomAmplitudeFactor());
      }

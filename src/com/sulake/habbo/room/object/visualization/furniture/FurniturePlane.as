   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2131)
         {
            if(!param1)
            {
               var_279.assign(var_618);
               var_278.assign(var_617);
            }
            else
            {
               var_279.assign(var_618);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_71 == null && var_895 != null || var_279 == null || var_278 == null || var_509 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1319)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1071 || _loc4_.y != var_1840 || _loc4_.z != var_1835 || param1.scale != var_1839))
            {
               var_1071 = _loc4_.x;
               var_1840 = _loc4_.y;
               var_1835 = _loc4_.z;

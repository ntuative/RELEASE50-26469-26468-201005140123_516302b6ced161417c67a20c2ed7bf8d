package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1547:int = 1500;
      
      private var var_1548:int = 255;
      
      private var var_1546:int = 255;
      
      private var var_1286:uint = 16777215;
      
      private var var_1057:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_551:
                  _loc2_.setString(RoomObjectVariableEnum.const_720,_loc3_.value);
                  break;
               ...
               case RoomObjectRoomUpdateMessage.const_734:
                  _loc2_.setString(RoomObjectVariableEnum.const_683,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_463:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_216)
                  {
                     _loc8_ = "null";
                  }
                  var_406.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_594:
                  _loc7_ = var_406.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_406.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_945,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_891,int(_loc5_.bgOnly));
            var_1286 = _color;
            var_1548 = var_1356;
            var_1057 = _loc11_;
            var_1546 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_991,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_610,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1280,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1267,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1311,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_271)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_891)
         {
            ...
            {
               _loc7_ = var_1286 >> 16 & 255;
               _loc8_ = var_1286 >> 8 & 255;
               _loc9_ = var_1286 & 255;
               _loc10_ = var_1057 >> 16 & 255;
               _loc11_ = var_1057 >> 8 & 255;
               _loc12_ = var_1057 & 255;
               _loc13_ = (_loc2_ - var_891) / var_1547;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1548 + (var_1546 - var_1548) * _loc13_;
               _color = _loc3_;
               var_1356 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_610,_loc3_);
         }
      }
   }
}

package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_936:IAvatarRenderManager = null;
      
      private var var_2250:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_540 != null)
         {
            ...
            {
               _loc1_ = var_540.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_988:
               ...
               break;
            case RoomObjectVisualizationEnum.const_132:
            ...
            case RoomObjectVisualizationEnum.const_252:
               ...
               break;
            case RoomObjectVisualizationEnum.const_852:
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_540.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_936;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_936;
            }
            if(var_2250)
            {
               var_540.add(param1,_loc6_);
            }
            return _loc6_;
         }
         return null;

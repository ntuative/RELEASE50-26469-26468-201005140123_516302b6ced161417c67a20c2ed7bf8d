package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_284:String = "object_icon_sprite";
      
      private static const const_764:int = -3;
      
      private static const const_765:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1058:String = "tile_cursor";
      
      private static const const_283:int = -1;
      ...
      private var var_259:IAdManager = null;
      
      private var var_579:NumberBank;
      ...
      private var var_695:RoomMessageHandler = null;
      
      private var var_694:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_306 = new Map();
         var_579 = new NumberBank(1000);
         var_1017 = new Map();
         var_307 = new Map();
         var_67 = new RoomObjectEventHandler(this);
         var_695 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_67 != null)
         {
            ...
            {
               return var_67.deleteWallItem(var_113,var_112,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_306.length; _loc2_++)
         {
            _loc3_ = var_306.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_742) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_715) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_571) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_569) + 0.5;
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_67.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_67.modifyWallItemData(var_113,var_112,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_430 != null)
         {
            var_430.release(new IIDRoomObjectVisualizationFactory());
            var_430 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_694 != null)
         {
            var_694.release(new IIDRoomRendererFactory());
            var_694 = null;
         }
         ...
         if(var_306 != null)
         {
            ...
            {
               _loc2_ = var_306.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_694.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1020;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_687);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_996);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_898);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_835) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_839);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_463,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_594,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_645,var_113,var_112,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            return var_67.modifyRoomObject(var_113,var_112,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_307.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_307.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_551,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_719,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_734,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_39);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_70);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_67 != null)
         {
            var_67.handleRoomObjectEvent(param1,var_113,var_112);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_226,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_334,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_314,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_946,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_960,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1018,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_620,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_29 == null || var_430 == null || var_41 == null || var_694 == null || _communication == null || _habboConfiguration == null || !var_1849)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_283,RoomObjectCategoryEnum.const_70);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1383,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_113,var_112));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_764,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_113,var_112,var_1219);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_284);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_113,var_112,var_1219);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_284);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_430 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_430;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               var_29.events.addEventListener(RoomObjectMouseEvent.const_228,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_486,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_275,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_521,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_134,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_116,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_136,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_100,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_387,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_406,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_418,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_437,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_372,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_472,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_68,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_424,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_445,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_274,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_413,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_329,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_315,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_405,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_803,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_415,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_430,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_113,var_112);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_546) != 0)
         {
            return false;
         }
         if(var_67 != null)
         {
            return var_67.initializeRoomObjectInsert(var_113,var_112,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_482 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_548,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_307.length)
            {
               _loc3_ = var_307.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_39));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_226));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_373);
                     break;
                  case RoomObjectCategoryEnum.const_39:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_169);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_313);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_673)
         {
            var_1849 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_226,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_334,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_314,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1020,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_259.events.addEventListener(AdEvent.const_484,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_765) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_67 != null)
         {
            var_67.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_67 != null)
         {
            return var_67.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_306.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_591,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_694 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_482 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_497);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_497,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_579.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_226,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_373,param8);
               break;
            case RoomObjectCategoryEnum.const_39:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_169,param2);
               break;
            case RoomObjectCategoryEnum.const_70:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_271,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_720,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_508,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_683,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_463,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1017.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_881,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_579.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_766,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_113,var_112,param1);
         if(_loc9_ != null)
         {
            var_1219 = param1;
            var_1474 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_284);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1474 - _loc12_.width / 2;
               _loc11_.y = var_1473 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_403,var_113,var_112,-1,RoomObjectCategoryEnum.const_217));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_283,const_496);
                  var_67.handleRoomObjectEvent(_loc14_,var_113,var_112);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_113,var_112,param1,param2,new Vector3d(),1,null);
         }
         else if(var_12 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_113,var_112,var_1219);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_284);
            _loc11_ = addOverlayIconSprite(_loc10_,const_284,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1474 - _loc6_.data.width / 2;
               _loc11_.y = var_1473 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_289,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_922,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_892,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_837,RoomObjectVariableEnum.const_289,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_306.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_306.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_673,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_67 != null)
         {
            var_67.cancelRoomObjectInsert(var_113,var_112);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_497);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_881);
               ...
               var_579.freeNumber(_loc10_ - 1);
               _loc13_ = var_1017.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_113,var_112,const_283,RoomObjectCategoryEnum.const_70,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_283,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_895,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_546,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_969,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_283,const_496,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_546,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_742,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_571,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_715,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_569,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_901,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_551,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_719,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_734,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_463,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_216);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_687,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_639,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_687,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_996,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_898,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_766,const_1058,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_764,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }

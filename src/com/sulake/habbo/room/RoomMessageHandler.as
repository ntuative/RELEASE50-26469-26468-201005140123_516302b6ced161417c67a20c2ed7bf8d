package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1058:int = -1000000000;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new CloseConnectionMessageEvent(method_9));
            ...
            param1.addMessageEvent(new DanceMessageEvent(method_11));
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_999:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1006:
                     _loc10_ = "std";
               }

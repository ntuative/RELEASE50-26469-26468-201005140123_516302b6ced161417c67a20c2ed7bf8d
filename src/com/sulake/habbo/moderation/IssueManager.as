package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_902:String = "issue_bundle_open";
      
      public static const const_730:String = "issue_bundle_my";
      
      public static const const_939:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_123 = new Map();
         var_805 = new Map();
         var_565 = new IssueBrowser(this,var_58.windowManager,var_58.assets);
         var_671 = [];
         var_804 = [];
         var_984 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_984.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_123)
         {
            switch(param1)
            {
               case const_902:
                  ...
                  break;
               case const_730:
                  if(_loc4_.state == IssueMessageData.const_419 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_123.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_671 = var_671.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_805.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_123.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_123.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_805.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_123)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_805.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_805.add(param1.issueId,_loc2_);
            var_123.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_671.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_145)
         {
            ...
            _loc8_ = var_804.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_419 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_804 = var_804.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_123.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_984.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_123.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_565 == null || !var_565.isOpen())
         {
            var_58.soundManager.playSound(HabboSoundTypesEnum.const_959);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_805.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_123.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_123.getValues();
         var _loc4_:int = var_58.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_419 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }

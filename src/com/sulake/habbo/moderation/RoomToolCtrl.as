package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_983:ICheckBoxWindow;
      ...
      private var var_670:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_568,_data.flatId),var_52,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_396);
         if(param1.flatId != var_396)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_396);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_670.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1238,_loc2_,var_439.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_983.isSelected,var_982.isSelected,var_670.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1305);
      }
      ...
      public function populate() : void
      {
         ...
         var_670 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_983 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_396));
         Logger.log("BEGINNING TO SHOW: " + var_396);
      }
   }
}

package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_408:UserInfoCtrl;
      
      private var var_58:ModerationManager;
      
      private var var_1020:UserInfoCtrl;
      
      private var var_114:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.releaseBundle(var_114.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_114.getHighestPriorityIssue();
         var_408 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_1020 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_408.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_114.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1020.load(_loc4_,var_114.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_114.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_114.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_114.getHighestPriorityIssue().issueId;
         var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_58,WindowTracker.const_810,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_58 != null && false && var_114 != null)
         {
            var_58.issueManager.removeHandler(var_114.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_114.getHighestPriorityIssue();
            var_408 = new UserInfoCtrl(_window,var_58,_loc3_.message);
            var_408.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_114.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_114.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1387;
      }
   }
}

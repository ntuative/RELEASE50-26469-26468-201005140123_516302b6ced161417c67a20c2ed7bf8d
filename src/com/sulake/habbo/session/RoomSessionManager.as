package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         var_829 = true;
         if(var_193.getValue(_loc6_) != null)
         {
      ...
      private function initializeManager() : void
      {
         ...
         {
            gotoRoom(var_1788,var_1787,var_1190);
            var_1191 = false;
            var_1190 = "";
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_193)
         {
            while(false)
            {
               _loc1_ = var_193.getKey(0) as String;
               _loc2_ = var_193.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_193.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_193.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_193.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_193.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_193.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {

package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1059:UserDataManager;
      ...
      {
         if(var_34 == RoomSessionEvent.const_323 && _connection != null)
         {
            var_34 = RoomSessionEvent.const_99;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1059 as IUserDataManager;
      }

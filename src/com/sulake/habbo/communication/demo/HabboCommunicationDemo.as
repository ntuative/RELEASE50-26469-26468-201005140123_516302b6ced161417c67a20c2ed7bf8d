package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_175:HabboHotelView;
      ...
      private var var_2048:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1537:ILogger;
      
      private var var_1280:String;
      
      private var var_2047:String;
      
      private const const_1431:String = "fuselogin";
      
      private var var_300:ICoreCommunicationManager;
      
      private var var_432:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1335:
            case DisconnectReasonEvent.const_1243:
            ...
            case DisconnectReasonEvent.const_1389:
               ...
               break;
            case DisconnectReasonEvent.const_1191:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2049)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_721 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_721);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1280,var_2047));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1431,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_432.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_432.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2048);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1431,"/");
      ...
      {
         var_721 = _habboConfiguration.getKey("sso.ticket",null);
         var_1280 = _habboConfiguration.getKey("flash.client.url","");
         var_2047 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_175 == null)
         {
            var_175 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_721 != null)
         {
            var_59.mode = HabboConnectionType.const_363;
            var_59.initConnection(HabboConnectionType.const_243);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1537 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_646);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2048 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_363:
               ...
               var_1047 = _loc4_;
               var_175.loadBannerImage(_loc7_ + "?token=" + var_1047,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_859:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1405:
               var_603 = generateRandomHexString(30);
               var_432 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_432.init(var_603);
               _loc8_ = var_432.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_175.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var_432 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_432.init(_loc14_);
            _loc15_ = var_432.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_859;
            }
         }
         var_59.initConnection(HabboConnectionType.const_243);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_161,onConfigurationLoaded);
         }
      }

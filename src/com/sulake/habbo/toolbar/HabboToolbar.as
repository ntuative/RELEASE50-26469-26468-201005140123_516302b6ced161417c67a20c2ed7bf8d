package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_130,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_977,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_158,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_186,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_51,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_462,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_737,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_953,onHideWindowEvent);
         var_34 = true;

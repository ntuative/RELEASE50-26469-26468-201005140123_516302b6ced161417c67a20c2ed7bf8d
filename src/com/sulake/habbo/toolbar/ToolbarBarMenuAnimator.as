package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_782:int = 50;
      
      private static const const_1057:Number = 25;
      
      private static const const_1108:int = 50;
      ...
      private var var_1072:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1072 = param2;
         var_620 = new Timer(const_1057);
         var_620.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_517.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_517.splice(_loc3_,1);
            var_516.splice(_loc3_,1);
         }
         var_516.push(param1.name);
         var_517.push(param2);
         param1.addEventListener(WindowEvent.const_426,windowEventListener);
         param1.addEventListener(WindowEvent.const_231,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_517[var_516.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1072.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            _loc3_.iconId = _loc4_.iconId;
            _loc3_.method_2 = _loc4_.menuLockedToIcon(param1);
            _itemList[_loc3_.menuId] = _loc3_;
            var_322.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_322.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_322.splice(var_322.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1072.getIconLoc(param1.iconId);
      ...
      {
         return var_516[var_517.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_619[_loc3_] = new Array();
            }
            if(var_619[_loc3_].indexOf(param1) < 0)
            {
               var_619[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_782 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_782 || param1.desktop.height - param1.y < const_1108;
      }
      
      public function method_4(param1:String, param2:Boolean) : void
      {
         var _loc3_:MenuAnimatorItem = getItemObject(param1);
         if(_loc3_ == null)
         {
         ...
         if(param2 && !isOutsideScreen(_loc4_) && !_loc3_.method_2)
         {
            return;
         }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_516.length)
         {
            if(var_516[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_619[_loc3_].length)
                  {
                     method_4(var_619[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }

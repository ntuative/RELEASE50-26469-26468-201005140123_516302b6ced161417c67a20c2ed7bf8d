package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_752:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_664.width,var_664.height,true,0);
            _loc1_.bitmap.copyPixels(var_664,var_664.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_912.width,var_912.height,true,0);
            _loc5_ = var_912.clone();
            _loc5_.colorTransform(_loc5_.rect,var_752.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_753.width,var_753.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_753,var_753.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {

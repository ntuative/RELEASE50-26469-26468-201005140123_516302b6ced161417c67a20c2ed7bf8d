package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1549:Number = 1;
      
      private var _b:uint;
      
      private var var_1550:Number = 1;
      ...
      {
         super();
         var_1598 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_2246 = parseInt(_loc2_,16);
         var_2247 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1464 = _rgb >> 16 & 255;
         var_1463 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1551 = var_1464 / 255 * 1;
         var_1550 = var_1463 / 255 * 1;
         var_1549 = _b / 255 * 1;
         if(var_1598 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1551,var_1550,var_1549,_alphaMultiplier);
         var_1101 = generatePaletteMapForGrayscale(var_2247,var_2246);
      }
      
      public function get reds() : Array
      {
         return var_1101.getValue("reds") as Array;
      }
      ...
      {
         return var_1101.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1101.getValue("greens") as Array;
      }
      ...
      {
         return var_1101.getValue("alphas") as Array;
      }

package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1511:String = "hot_looks";
      
      public static const const_1587:String = "my_looks";
      ...
      {
         super(param1);
         var_388 = new Dictionary();
         var_388["null"] = new Array();
         var_388["null"] = new Array();
         var_388["undefined.index"] = 0;
         var_388["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_388[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {

package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_861:AvatarEditorHandler;
      ...
      private const const_1068:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_702.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_164)
         {
            ...
            var_492["null"] = new FigureData(this);
            var_492["null"] = new FigureData(this);
            _loc1_ = var_492["null"];
            _loc2_ = var_492["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_86);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_88);
            var_89 = new Map();
            var_420 = new Map();
            var_89.add(AvatarEditorFigureCategory.const_929,new BodyModel(this));
            var_89.add(AvatarEditorFigureCategory.const_49,new HeadModel(this));
            var_89.add(AvatarEditorFigureCategory.const_319,new TorsoModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1264,new LegsModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1144,new HotLooksModel(this));
            var_420.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_420.add(AvatarEditorSideCategory.const_367,new ClubPromoModel(this));
            var_164 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1029 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1504;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1029 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1068)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1176)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1029 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_420.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_861 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_702.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_929);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_702 = var_592.getFigureData(AvatarType.const_84);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_592 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1029 = param3;
         var _loc4_:FigureData = var_492[param2];
         if(_loc4_ == null)
         {
            return;
         }

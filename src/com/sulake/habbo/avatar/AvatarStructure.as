package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_391:PartSetsData;
      
      private var var_1714:PartOffsetData;
      
      private var var_807:AvatarActionManager;
      
      private var var_168:IAssetLibrary;
      
      private var var_985:IAssetLibrary;
      
      private var var_1713:AvatarRenderManager;
      ...
      private var var_1424:AvatarStructureDownloadSet;
      
      private var var_1163:Array;
      
      private var var_675:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_391 = new PartSetsData();
         _animationData = new AnimationData();
         var_1424 = new AvatarStructureDownloadSet();
         var_675 = new AnimationManager();
         var_674 = param4;
         var_1714 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_807.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_807.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_807.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_675.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_391.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_391.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1309[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_807.getDefaultActionType();
         var _loc9_:Array = var_391.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_675.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_391.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_391.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_674 + " ready to go!");
         if(var_674 == AvatarType.const_84)
         {
            var_391.getPartDefinition("ri").appendToFigure = true;
            var_391.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_674)
         {
            case AvatarType.const_84:
               ...
               var_1424.add(new AvatarStructureDownload(var_168,_loc5_,var_295));
               break;
            case AvatarType.PET:
         }
         var_1424.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_675.getAnimation(param1);
      }
      ...
      {
         var_807 = new AvatarActionManager(var_168,var_674);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1163 = var_295.getMandatorySetTypeIds();
         return var_1163;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_985.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_985.getAssetByName("dance" + _loc1_).content as XML;
            var_675.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_985.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_985.getAssetByName("fx" + _loc1_).content as XML;
            var_675.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_807.sortActions(param1);
      }
   }
}

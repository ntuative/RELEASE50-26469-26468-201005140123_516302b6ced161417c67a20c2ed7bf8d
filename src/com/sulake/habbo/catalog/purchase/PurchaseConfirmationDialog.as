package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1424:uint = 4.294967295E9;
      
      private const const_1425:uint = 4.293848814E9;
      
      private var var_793:int;
      
      private const const_1642:uint = 4.291613146E9;
      
      private var var_251:int = -1;
      
      private var var_216:IWindowContainer;
      
      private var var_968:String;
      
      private var var_467:IWindowContainer;
      ...
      private const const_1641:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_216.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_794;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_794,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1425) : uint(const_1424);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_441,var_79,var_968);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_216.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_251) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_794);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_559[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_560[var_188]);
         _catalog.purchaseProductAsGift(var_441,var_79,var_968,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_135:
               ...
               for each(_loc7_ in var_225)
               {
                  ...
                  if(_loc5_.length >= const_1641)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1669 = _loc3_.text;
               break;
            case WindowMouseEvent.const_54:
               showSuggestions(false);
               if(var_1141)
               ...
               break;
            case WindowKeyboardEvent.const_623:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_251 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_251 + 1);
                     break;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_82:
                  ...
                  break;
               case ProductTypeEnum.const_235:
                  _loc6_ = _catalog.getPixelEffectIcon(_loc7_);
                  break;
               case ProductTypeEnum.const_317:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1410 = _loc1_.stuffTypes;
            var_559 = _loc1_.boxTypes;
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_216.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_251) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_251);
         }
         var_251 = param1;
         if(var_251 < 0)
         {
            var_251 = _loc2_.numListItems - 1;
         }
         if(var_251 >= _loc2_.numListItems)
         {
            var_251 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_251) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_216 == null)
         {
            var_216 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_467 == null)
         {
            var_467 = createWindow("suggestion_list_item") as IWindowContainer;
            var_467.procedure = suggestionsEventHandler;
         }
         if(var_216 == null || var_467 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_216.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_467.clone() as IWindowContainer;
            if(_loc5_ != null)
            {

package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1067:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1496:XML;
      
      private static var var_1495:XML;
       
      
      private var var_2324:IWindowContainer;
      ...
      private var var_1494:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1495 == null)
         {
            ...
            var_1495 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1494 == 4294967295)
            {
               var_1494 = _loc1_.color;
            }
            _loc1_.color = const_1067;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1394;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1496) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1495) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1323;
            }
         }
      }

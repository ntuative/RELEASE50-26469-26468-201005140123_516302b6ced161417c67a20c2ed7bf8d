package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_254 != null && var_257 != null)
         {
            setRoomImage(var_254,var_257);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_155.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_221 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_221];
                  if(_loc9_ != null)
                  {
                     var_1234 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_155.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_255];
               if(_loc13_ != null)
               {
                  var_1235 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_195:
               ...
               for each(_loc8_ in var_155.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_680 = _loc8_.children().length();
                  }
               }
            ...
            case const_193:
               ...
               if(var_298 >= _activeFloorPatterns.length)
               {
                  var_298 = 0;
               }
               var_256 = 0;
               ...
               for each(_loc9_ in var_155.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_678 = _loc9_.children().length();
                  }
               }
            ...
            case const_194:
               ...
               for each(_loc10_ in var_155.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_679 = _loc10_.children().length();
                  }
               }

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1150 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_301 = null;
         for each(_loc1_ in var_1149)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1150) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_664.width,var_664.height,true,0);
               _loc3_.bitmap.copyPixels(var_664,var_664.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_912.width,var_912.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_753.width,var_753.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_753,var_753.rect,new Point(0,0),null,null,true);

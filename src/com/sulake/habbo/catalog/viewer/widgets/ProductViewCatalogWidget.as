package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_601:IItemGridWindow;
      
      private var var_85:IBitmapWrapperWindow;
      
      private var var_1371:ITextWindow;
      
      private var var_1277:IScrollbarWindow;
      
      protected var var_1214:XML;
      
      private var var_1278:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_601 != null)
         {
            var_601.visible = false;
            var_601.destroyGridItems();
         }
         if(var_1277 != null)
         {
            var_1277.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1371.text = "${" + _loc3_.name + "}";
            var_1372.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1371.text = "${" + _loc2_.localizationId + "}";
            var_1372.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_412:
                  _loc4_ = var_1278.clone();
                  if(var_601 != null)
                  {
                     var_601.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_601,var_1277,var_1214);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_235:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_312,AvatarAction.const_647);
                              _loc13_.appendAction(AvatarAction.const_615,_loc6_.productClassId);
      ...
      {
         var_1371 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1372 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1534 = new Point(var_85.x,var_85.y);
         var_601 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1277 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_601 == null)
         {
         ...
         var_1278 = _loc2_.content as BitmapData;

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1006 != null)
         {
            var_1006.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1007 != null)
         {
            var_1007.removeEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1006 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1006 != null)
         {
            var_1006.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1007 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1007 != null)
         {
            var_1007.addEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }

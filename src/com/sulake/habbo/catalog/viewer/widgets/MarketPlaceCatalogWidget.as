package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_816:MarketPlaceOfferData;
      ...
      private const const_1417:int = 2;
      ...
      private const const_1650:int = 10;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1417,_loc2_.length);
         if(!var_393)
         {
            var_393 = new Timer(25);
            var_393.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_815 = 0;
         populateList();
         var_393.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_568)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_392.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_393)
         {
            var_393.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_393 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_815 >= var_568.length)
            {
               return true;
            }
            addListItem(var_568.getWithIndex(var_815));
            ++var_815;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_816.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_392));
            _loc7_.selection = 0;
         }
      }

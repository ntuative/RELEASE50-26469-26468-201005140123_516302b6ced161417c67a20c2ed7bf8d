package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1410:String = "ctlg_";
      ...
      private var var_1226:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_838:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1410 + param1;
         ...
         var_1395 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1395) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_850);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1252) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1226;
            _loc2_.init();
         }
         var_1226.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1226.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_850);
      }

package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1055:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_604 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_604.width;
         var_94 = var_604.height;
         var_1054 = param5;
         var_890 = param6;
         var_232 = Math.floor(var_1054 / _thumbWidth);
         var_19 = new BitmapData(var_1054,var_890);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_232 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_232 - param1.x - 1;
         ...
         if(var_19.height < var_890)
         {
            _loc12_ = new BitmapData(var_19.width,var_890);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_604.width,var_604.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_604.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_604,var_604.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1055 != null)
         {
            _loc1_ = var_1055.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_232 * _thumbWidth,var_1054),Math.max(var_508 * var_94,var_890),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_232 && var_19.height < _loc3_.y * var_94)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_232 - 1),var_94);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_232 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_232 - 1),0 - var_94);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_232));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_232);
         var _loc3_:int = param1 % var_232;
         return new Point(_loc3_,_loc2_);
      }

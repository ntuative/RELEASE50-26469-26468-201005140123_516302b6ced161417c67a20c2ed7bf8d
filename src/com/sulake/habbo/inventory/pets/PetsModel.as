package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1148 && param1.type == RoomEngineObjectEvent.const_203)
         {
            var_28.showView();
            var_1148 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1148 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_302,_loc3_.figure);
            var_28.closeView();
            return;
         }
      ...
      {
         if(var_977.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }

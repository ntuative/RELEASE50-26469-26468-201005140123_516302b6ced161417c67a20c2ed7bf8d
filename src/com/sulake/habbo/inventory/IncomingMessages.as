package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_11.method_3;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_562);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_185)
            {
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_343))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_144);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_11.setInventoryCategoryInit(InventoryCategory.const_288);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_244);
      ...
      {
         var _loc2_:PetsModel = var_11.method_3;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_276);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_343);
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();

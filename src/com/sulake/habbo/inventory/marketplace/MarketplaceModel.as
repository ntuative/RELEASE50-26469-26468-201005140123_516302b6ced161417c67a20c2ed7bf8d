package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_224 is FloorItem ? 1 : 2;
         var_1807 = _loc2_;
         var_1811 = var_224.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_224.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1456,var_1457);
         }
      }
      ...
      {
         if(param1 != var_1807 || param2 != var_1811)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1809);
      }
      ...
      {
         if(var_28 != null && false && var_224 != null)
         {
            var_28.furniModel.removeLockFrom(var_224.id);
            var_224 = null;
         }
      }

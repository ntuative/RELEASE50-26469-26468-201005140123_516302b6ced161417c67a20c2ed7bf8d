package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_758:MarketplaceModel;
      
      private var var_530:Map;
      
      private var var_531:String;
      
      private const const_1670:int = 2;
         ...
         else if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_342);
            }
         }
      }
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_300)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_185)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_758 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else

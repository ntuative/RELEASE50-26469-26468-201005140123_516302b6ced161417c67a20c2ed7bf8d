package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_797:IRoomSession;
      ...
      private var var_976:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_478,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_99:
               var_797 = param1.session;
               _view.setHabboToolbarIcon();
               method_3.updatePetsAllowed();
               break;
            case RoomSessionEvent.const_104:
               var_797 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_478:
               method_3.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_562));
      }
      ...
      public function get method_3() : PetsModel
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_144));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_818));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1643);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_288));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_244:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_798.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_798.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_244));
      }
      ...
      {
         return var_46.getValue(InventoryCategory.const_343) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_976 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_276));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_478,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_343,_loc3_);
         ...
         var_46.add(InventoryCategory.const_144,_loc10_);

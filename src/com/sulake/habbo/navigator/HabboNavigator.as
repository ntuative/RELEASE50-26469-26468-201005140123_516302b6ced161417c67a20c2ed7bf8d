package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_939:RoomCreateViewCtrl;
      
      private var var_1964:RoomThumbnailRenderer;
      
      private var var_199:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_635:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_433:Tabs;
      
      private var var_287:MainViewCtrl;
      
      private var var_2266:Array;
      
      private var var_1012:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_287 = new MainViewCtrl(this);
         var_635 = new RoomInfoViewCtrl(this);
         var_939 = new RoomCreateViewCtrl(this);
         var_1964 = new RoomThumbnailRenderer(this);
         var_1012 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_433 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_287.startSearch(Tabs.const_199,Tabs.const_304,param1);
         var_287.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_287.startSearch(Tabs.const_242,Tabs.const_227);
         var_433.getTab(Tabs.const_242).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_287.onNavigatorToolBarIconClick();
         if(_loc1_)
         {

package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1486:CutToHeight = new CutToHeight();
      
      private static var var_1485:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1486.beforeSearch(param2,param1,param3);
         binarySearch(var_1486,param2.length - 1);
      }

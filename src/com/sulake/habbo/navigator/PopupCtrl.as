package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_370 = new Timer(500,1);
         var_324 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1310 = param4;
         var_1880 = param2;
         _popupIndentLeft = param3;
         var_370.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_370)
         {
            var_370.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_370.reset();
            var_370 = null;
         }
         if(var_324)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_50 == null)
         {
            var_50 = IWindowContainer(_navigator.getXmlWindow(var_1310));
            var_50.visible = false;
         ...
         var_50.x = _loc2_.x + var_1880 + param1.width;

package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_866:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_503 = new Timer(100);
         var_503.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
         ...
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,540,"t"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,512,"w"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,396,"x"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,440,"y"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,456,"z"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1034 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_503)
         {
            var_503.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_503.reset();
            var_503 = null;
         }
      }
      ...
      {
         var_1034.goBackToInitialState();
         var_1034.input.textBackgroundColor = 4294967295;
         var_866 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1034.getText();
      ...
      {
         var _loc1_:Boolean = var_1034.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_866.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1256 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1256 = true;
            _loc3_.y = 1;

package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1490:IButtonWindow;
      ...
      private var var_1489:IButtonWindow;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1489,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1490,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_57;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1489 = IButtonWindow(find("top_tab"));
         var_1490 = IButtonWindow(find("obj_tab"));
         var_1885 = IWindowContainer(find("tile_grid"));
         var_1884 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1489,onTopTabButton);
         Util.setProcDirectly(var_1490,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1885;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_444)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1884;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,param1.width,66)));
      ...
      private function refreshImgSelectors() : void
      {
         ...
         refreshImgSelector(ThumbnailEditorModel.const_57);

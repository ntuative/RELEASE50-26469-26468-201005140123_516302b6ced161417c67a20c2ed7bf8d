package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_787:int = 32;
      
      private static const const_1118:int = 8;
      
      public static const const_444:int = 10;
      
      private static const const_1120:int = 40;
      ...
      private var var_913:ThumbnailImageConfigurations;
      
      private var var_1344:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_1089 = new Dictionary();
         super();
         _navigator = param1;
         var_913 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_913.getImage(ThumbnailEditorModel.const_36,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1119,_loc4_.y + const_1120 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2178[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_913.getImage(ThumbnailEditorModel.const_41,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_913.getImage(ThumbnailEditorModel.const_41,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_913.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_787 / 2);
         return new Point(param1 * const_787 + _loc3_,param2 * const_1118);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_444)
         {
            var_1089[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1089[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_444)
         {
            if(false)
            {
               refreshObj(param1,var_1089[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1344 == null)
         {
            var_1344 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1344,var_1344.rect,new Point(0,0),null,null,true);
      }
   }
}

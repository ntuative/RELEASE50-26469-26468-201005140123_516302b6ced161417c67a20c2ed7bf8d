package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_466:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_466 == null ? 0 : int(var_466.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_301);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_552);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_301,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_466 == null)
         {
            var_466 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_466.procedure = onChangeFilter;

package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_541:IDropMenuWindow;
      
      private var var_2406:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_572;
         }
         if(param1 == 2)
         {
            return Tabs.const_576;
         }
         if(param1 == 3)
         {
            return Tabs.const_675;
         }
         if(param1 == 4)
         {
            return Tabs.const_682;
         }
      ...
      {
         var _loc1_:int = var_541 == null ? 0 : int(var_541.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_242,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_541 == null)
         {
            var_541 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_541.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }

package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1107:int = 4;
      ...
      private var var_1313:IRegionWindow;
      
      private var var_438:int;
      
      private var var_1315:Boolean = true;
      
      private var var_739:GuestRoomListCtrl;
      ...
      private var var_905:OfficialRoomListCtrl;
      
      private var var_20:IWindowContainer;
      
      private var var_740:PopularTagsListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_740 = new PopularTagsListCtrl(_navigator);
         var_739 = new GuestRoomListCtrl(_navigator);
         var_905 = new OfficialRoomListCtrl(_navigator);
      ...
      private function prepare() : void
      {
         ...
         var_217 = ITabContextWindow(var_14.findChildByName("tab_context"));
         var_20 = IWindowContainer(var_14.findChildByName("tab_content"));
         var_236 = IWindowContainer(var_14.findChildByName("custom_content"));
         var_208 = IWindowContainer(var_14.findChildByName("list_content"));
         ...
         var_1313 = IRegionWindow(var_14.findChildByName("to_hotel_view"));
         var_1313.procedure = onHotelView;
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_1190,true);
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = var_208.getChildByName(param4);
      ...
      {
         refreshScrollbar(var_740);
         refreshScrollbar(var_739);
      }
      ...
      {
         refreshList(param1,param2,var_905,"official_rooms");
      }
      
      private function refreshGuestRooms(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_739,"guest_rooms");
      }
      ...
      {
         refreshList(param1,param2,var_740,"popular_tags");
      }
      ...
      public function refresh() : void
      {
         ...
         var_208.height = var_208.height + _loc1_ - 0 - 0 + var_2125;
         Util.moveChildrenToColumn(var_20,["list_content","custom_footer"],var_208.y,8);
         var_2125 = var_277.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_438 == const_780)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_208.blend - _loc2_));
            this.var_208.blend = _loc3_;
            this.var_236.blend = !!var_1315 ? Number(_loc3_) : Number(1);
            this.var_277.blend = !!var_1315 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_438 = const_503;
            }
         }
         else if(var_438 == const_503)
         {
            if(var_1312 % 10 == 1)
            {
      ...
      {
         _navigator.refreshButton(var_1313,"icon_hotelview",!param1,null,0);
         _navigator.refreshButton(var_1313,"icon_hotelview_reactive",param1,null,0);
      }

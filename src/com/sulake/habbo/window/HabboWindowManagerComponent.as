package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_356:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1126:uint = 1;
      ...
      private var var_1353:ProfilerAgentTask;
      
      private var var_1352:IEventDispatcher;
      
      private var var_2402:uint = 0;
      
      private var var_1355:ProfilerAgentTask;
      
      private var var_1354:ProfilerOutput;
      
      private var var_757:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1352 = Component(param1).events;
         var_449 = new Array();
      ...
      {
         return var_243[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_243[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_667 = new SkinContainer(_loc3_.content as XML,assets);
         var_757 = new WindowRenderer(var_667);
         var_243 = new Array(const_356);
         var _loc5_:int = 0;
         while(_loc5_ < const_356)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_757,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_243[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_243[const_1126];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_306,_loc6_);
      ...
      {
         var _loc3_:IDesktopWindow = var_243[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_243.pop()).dispose();
            }
            var_243 = null;
            while(false)
            {
      ...
      {
         return var_243[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1354 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1354 = new ProfilerOutput(_loc3_,this,var_757);
               var_1353 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1353);
               var_1355 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1355);
               var_1095 = true;
            }
         }
      }
      ...
      {
         return var_667.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_949.length > 0)
         {
            var_1352.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_356 - 1;
            while(_loc2_ >= 0)
            {
               var_243[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1095)
         ...
         var_1352.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_356)
         {
            var_243[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1095)
         {
         ...
         if(WindowContext.var_949.length > 0)
         {
            WindowContext.var_949.flush();
         }
         if(WindowContext.var_1385.length > 0)
         {
            WindowContext.var_1385.flush();
         }
         var_1352.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1161,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1185,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1192,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1298,param2.name + ": " + param2.toString());
            }
         }
      }
   }
